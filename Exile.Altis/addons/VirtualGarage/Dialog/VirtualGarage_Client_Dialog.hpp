...
class VirtualGarageDialog
{
	...
	class Controls
	{
        ...
        class VirtGarageStoredVehiclesList: VirtGarageRscListbox
        {
		  ...
		  onSetFocus = "call ExileClient_VirturalGarage_hideVehicleNameEditor";
        };
        class VirtGarageNearVehiclesList: VirtGarageRscListbox
        {
		  ...
		  onSetFocus = "call ExlieClient_VirtualGarage_showVehiclNameEditor";		  
        };
		...
		class enterVehicleName: VirtGarageRscEdit
		{
			...
			onKeyUp = "call ExileClient_VirtualGarage_updateVehicleName";
		};
		...
		class selectNickName: VirtGarageRscButton
		{
            ...
            colorBackgroundActive[] ={1,1,1,0.05};
            colorFocused[] ={1,1,1,0};				
			onButtonClick = "call ExileClient_VirtualGarage_setVehicleNickname";	
		};
		class directions: VirtGarageRscStructuredText
		{
			idc = 1103;
			text = "Select a Vehicle to Store or Pull from the Garage"; //--- ToDo: Localize;
