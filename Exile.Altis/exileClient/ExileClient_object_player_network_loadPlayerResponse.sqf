...
// Get the level7 time remaining from the server 
// This is stored by by a routine called as a response to the request below 
// so this is not exactly transparent.
//false call GRG_getLevel7TimeRemainingRequest;
//diag_log format["ExileClient_object_player_network_loadPlayerResponse: level 7 timer initialized"];
true